...
# Invocation: brainome wdbc_clean_synth_labelled.csv -o wdbc_clean_synth_labelled.py -e 5 -y
# Total compiler execution time: 1:58:43.92. Finished on: May-01-2024 16:12:36.
...
[01;1mPredictor:[0m                        
    ...
    Accuracy:
      Best-guess accuracy:        95.45%
      Training accuracy:          95.45% (171811/179999 correct)
      Validation Accuracy:        95.45% (19091/20001 correct)
      Combined Model Accuracy:    95.45% (190902/200000 correct)


    Model Capacity (MEC):        65    bits
    Generalization Ratio:       705.53 bits/bit
    Percent of Data Memorized:     0.44%
    Resilience to Noise:          -3.42 dB
    ...
    Training Accuracy by Class:
          ...
          ---------- | ------- ------- ------- ------- -------- -------- -------- -------- -------- --------
                 0.0 |  171811    8188       0       0  100.00%    0.00%   95.45%      N/A   97.67%   95.45%
                 1.0 |       0       0  171811    8188    0.00%  100.00%      N/A   95.45%    0.00%    0.00%

    Validation Accuracy by Class:
          Prediction |      TP      FP      TN      FN     TPR      TNR      PPV      NPV       F1       TS 
          ---------- | ------- ------- ------- ------- -------- -------- -------- -------- -------- --------
                 0.0 |   19091     910       0       0  100.00%    0.00%   95.45%      N/A   97.67%   95.45%
                 1.0 |       0       0   19091     910    0.00%  100.00%      N/A   95.45%    0.00%    0.00%
...
TRAINFILE = ['wdbc_clean_synth_labelled.csv']
mapping = {'0.0': 0, '1.0': 1}
ignorelabels = []
ignorecolumns = []
target = 'Prediction'
...
n_classes = 2
model_cap = 65
w_h = np.array([[-0.29363858699798584, -0.37322595715522766, -0.5276623964309692, -0.24237480759620667, 0.05846104398369789, -0.4261838495731354, -0.5566827654838562, -0.45974960923194885, -0.7287854552268982, -0.10414503514766693, -0.5075666308403015, -0.5885732173919678, -0.5490656495094299, -0.05064328387379646, -0.07028573006391525, 0.0327422060072422, -0.14254213869571686, -0.4442082941532135, -0.42060816287994385, -0.1716705560684204, 0.056344930082559586, -0.18187372386455536, -0.5044844150543213, -0.5031558871269226, -0.7090055346488953, -0.2060547024011612, -0.5426054000854492, -0.6856688261032104, 0.08009245991706848, -0.5808085203170776], [-0.3488665819168091, -0.17555110156536102, -0.28581148386001587, -0.5909727215766907, -0.6496029496192932, 0.04555026441812515, -0.22909095883369446, 0.059654176235198975, -0.4447568953037262, -0.17203585803508759, -0.39862504601478577, -0.318860799074173, -0.5633301138877869, -0.1531612128019333, -0.1626037210226059, -0.30851125717163086, -0.3969849646091461, 0.03201287239789963, -0.00012879681889899075, -0.6218764185905457, -0.1222161129117012, -0.4452085494995117, -0.5085210800170898, -0.22181786596775055, -0.5245229601860046, -0.1996508687734604, -0.21456938982009888, -0.6211015582084656, -0.22750544548034668, -0.1151575818657875]])
b_h = np.array([-0.29962459206581116, 0.07451847195625305])
w_o = np.array([[0.26018306612968445, 0.12158707529306412]])
b_o = np.array(-3.0824599266052246)
